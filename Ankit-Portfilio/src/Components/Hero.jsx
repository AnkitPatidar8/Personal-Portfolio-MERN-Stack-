  ...
  return (
    <div className="bg-neutral-900 min-h-screen flex items-center py-8 sm:py-10">
      ...
      <a
        ...
        className="z-20 fixed bottom-4 left-4 bg-green-700 text-white flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 text-sm sm:text-base"
      >
        {/* <FaWhatsapp size={20} /> */}
      ...
      <div className="w-[92%] sm:w-[90%] bg-neutral-800 max-w-6xl mx-auto rounded-xl shadow-lg p-4 sm:p-6 md:p-8 flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0 md:h-auto">
        ...
        <div className="w-full md:w-3/5 px-2 sm:px-4 text-center md:text-left">
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-400 to-cyan-500 text-transparent bg-clip-text leading-snug">
